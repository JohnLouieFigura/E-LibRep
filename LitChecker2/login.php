...
mysqli_select_db($con,$db);
		   ...
		   $sqlSelect = mysqli_query($con,"select * from user where username='$u' and password='$p'");
				...
				<form name="signup" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10 offset-md-1 pt-5">
                            <input type="text" id="user_name" class="form-control" name="uname" placeholder="Username">
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-10 offset-md-1">
                            <input type="password" id="first_name" class="form-control" name="pass" placeholder = "Password">
                        </div>
                    </div>
