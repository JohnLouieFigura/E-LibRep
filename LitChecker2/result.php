...
<div class="result-bar"> 
	...
	<?php
      ...
      include 'config.php';
        ...
        $sqlselect = mysqli_query($conn,"select id,title,category,date,type,link,view,download,author_1,author_2,author_3,author_4  from literature where title like '%$search_this%' "); 
